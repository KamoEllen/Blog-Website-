...
export default function SinglePost() {
  return (
    <div className='singlePost'>
      ...
      <img src="https://i.pinimg.com/564x/68/68/7b/68687bf74257e86caab58aafddc326a7.jpg"
      ...
      <h1 className="singlePostTitle">
       ...
       <br/>
          ...
          <p className="singlePostDesc">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed 
